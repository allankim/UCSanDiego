...
// in simulator we redefine to format for UCSanDiego Developer console
...
{\
	NSString * exceptionName = [@"org.ucsandiego." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ucsandiego";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIUCSanDiegoNativeItemNone = -1, 
	UIUCSanDiegoNativeItemSpinner = -2,
	UIUCSanDiegoNativeItemProgressBar = -3,
	
	UIUCSanDiegoNativeItemSlider = -4,
	UIUCSanDiegoNativeItemSwitch = -5,
	UIUCSanDiegoNativeItemMultiButton = -6,
	UIUCSanDiegoNativeItemSegmented = -7,
	
	UIUCSanDiegoNativeItemTextView = -8,
	UIUCSanDiegoNativeItemTextField = -9,
	UIUCSanDiegoNativeItemSearchBar = -10,
	
	UIUCSanDiegoNativeItemPicker = -11,
	UIUCSanDiegoNativeItemDatePicker = -12,
	
	UIUCSanDiegoNativeItemInfoLight = -13,
	UIUCSanDiegoNativeItemInfoDark = -14,
	
	UIUCSanDiegoNativeItemDisclosure = -15,
	
	UIUCSanDiegoNativeItemContactAdd = -16
};
