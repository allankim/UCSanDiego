...
//@interface UCSanDiegoObject : NSObject
//@end

@interface UCSanDiegoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UCSanDiegoObject class]])
		{
			for (NSString *key in [[(UCSanDiegoObject*)o modules] allKeys])
			{
